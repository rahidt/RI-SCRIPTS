...
#output files
RESULT_DIR = "LogParseResults/"
ALL_CMDS_F_NAME         = RESULT_DIR + "ri_all_orig.cmd" #include prefixes
ALL_CTL_CMDS_F_NAME     = RESULT_DIR + "ri_ctl.cmd" 
ALL_ENV_CMDS_F_NAME     = RESULT_DIR + "ri_env.cmd" 
ALL_PROBLEM_CMDS_F_NAME = RESULT_DIR + 'ri_to_debug.cmd'
